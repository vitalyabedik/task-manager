...
export const todolistsReducer = (state: TodolistType[], action: TodolistsActionsType) => {
    switch (action.type) {
...
export type TodolistsActionsType = RemoveTodolistACType | AddTodolistACType | ChangeTodolistTitleAC | ChangeTodolistFilterACType
